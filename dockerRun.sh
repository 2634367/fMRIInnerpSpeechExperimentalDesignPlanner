#!/usr/bin/env bash
# Build and run the fMRI Experimental Design Planner in a hardened container.
#
...
IMAGE="${PLANNER_IMAGE:-fmri-planner:latest}"
CONTAINER="${PLANNER_CONTAINER:-fmri-planner}"
HOST_PORT="${PLANNER_PORT:-8760}"
CONTAINER_PORT=8760
