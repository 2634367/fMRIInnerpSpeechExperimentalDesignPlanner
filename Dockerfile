# fMRI Experimental Design Planner - hardened Alpine image.
#
...
LABEL org.opencontainers.image.title="fMRI Experimental Design Planner" \
      org.opencontainers.image.description="Design planner and scanner-time optimiser for the dense single-participant inner-speech decoding study." \
      org.opencontainers.image.vendor="Wright State University" \
      org.opencontainers.image.licenses="NOASSERTION" \
      org.opencontainers.image.source="https://example.invalid/fmri-experimental-design-planner"
...
port=os.environ.get('PLANNER_PORT','8760');\
